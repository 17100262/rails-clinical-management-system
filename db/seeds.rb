...
estrogen_receptors: ["positives","negatives","unknown"].sample,
progesterone_receptors: ["positives","negatives","unknown"].sample,
her2: ["positive","negative"].sample,
...
sentinel_ganglion: ["Yes","No"].sample,
axillary_emptying: ["Yes","No"].sample,
adjuvant_chemotherapy: ["Yes","No"].sample,
adjuvant_radiotherapy: ["Yes","No"].sample,
adjuvant_hormone_therapy_duration: Faker::Number.between(1, 10),
adjuvant_hormone_therapy_treatment: ["Tamoxifeno", "Inhibitor Aromatase","Goserelina"].sample,
